		...
		if( in_array($ext,$allowedExt) ){
			if( ($size/1024)<=500 ){
				...
				if( move_uploaded_file($tmp_name,$path) ){
					$query="UPDATE `users2` SET `propic` = '$path' WHERE uid='$uid'";
...
$sql = "SELECT * FROM  `users2` WHERE  `uid`= '$uid'";
	  ...
	  <div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		  ...
		  <ul class="nav navbar-nav navbar-right">
			<li>
				<a href="profile1.php?userid=<?php echo $row['uid']; ?>">
				<img src="<?php echo $row['propic']; ?>" height="35" />
				<?php echo $row['username']; ?>
				</a>
			</li>			
			<li><a href="home2.php" style="background:green;color:#fff;font-size:18px;margin-left:3px;">Home</a></li>			
			<li><a href="updateprofile2.php" style="background:green;color:#fff;font-size:18px;margin-left:3px;">Update Profile</a></li>			
			<li><a href="logout.php" style="background:green;color:#fff;font-size:18px;margin-left:3px;">LogOut</a></li>			
		  </ul>
		</div><!-- /.navbar-collapse -->
	  </div><!-- /.container-fluid -->
	</nav>
		...
		<div class="row">
			...
			<div class="col-md-4 sidebar">
				...
				<div class="list-group">
				  <a href="#" class="list-group-item active"style="color:#fff;font-size:18px;">Search History</a>
				  <a href="#" class="list-group-item" style="background:green;color:#fff;font-size:18px;">Account Privacy</a>
				  <a href="#" class="list-group-item" style="background:green;color:#fff;font-size:18px;">Invite Contacts</a>
				  <a href="changepwd1.php" class="list-group-item" style="background:green;color:#fff;font-size:18px;">Change Password</a>
				  <a href="logout.php" class="list-group-item" style="background:green;color:#fff;font-size:18px;">Log out</a>
			...
			<div class="col-md-8">
				...
				<?php 
				$ptquery = "SELECT * FROM posts2 order by pt DESC LIMIT 0,50";
					...
					<div class="panel panel-default">
						<div class="panel-body">
						   ...
						   <section class="post-footer">
							   ...
							   <?php 
							   $postid=$pro['pid'];
							   $sql1 = "SELECT * FROM `likes2` WHERE `pid`='$postid'";
							   ...
							   ?>
									<ul class="list-unstyled">
										<li>
										<?php 
										$q2="select * from likes2 where pid='$postid' and uid='$uid'";
										...
										<span class="badge"><?php echo $num1-1; ?></span>	
										</button>

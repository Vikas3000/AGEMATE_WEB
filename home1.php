		...
		if( in_array($ext,$allowedExt) ){
			if( ($size/1024)<=500 ){
				...
				if( move_uploaded_file($tmp_name,$path) ){
					$query="UPDATE `users1` SET `propic` = '$path' WHERE uid='$uid'";
...
$sql = "SELECT * FROM  `users1` WHERE  `uid`= '$uid'";
	  ...
	  <div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		  ...
		  <ul class="nav navbar-nav navbar-right">
			...
			<li><a href="home1.php" style="background:green;color:#fff;font-size:18px;margin-left:3px;">Home</a></li>			
			<li><a href="updateprofile1.php" style="background:green;color:#fff;font-size:18px;margin-left:3px;">Update Profile</a></li>			
	...
	<div class="container-fluid" id="h">
		<div class="row">
			...
			<div class="col-md-8">
				...
				<?php 
				$ptquery = "SELECT * FROM posts1 order by pt DESC LIMIT 0,50";
					...
					<div class="panel panel-default">
						<div class="panel-body">
						   ...
						   <section class="post-footer">
							   ...
							   <?php 
							   $postid=$pro['pid'];
							   $sql1 = "SELECT * FROM `likes1` WHERE `pid`='$postid'";
							   ...
							   ?>
									<ul class="list-unstyled">
										<li>
										<?php 
										$q2="select * from likes1 where pid='$postid' and uid='$uid'";

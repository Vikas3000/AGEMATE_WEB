	  ...
	  <div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		  ...
		  <ul class="nav navbar-nav navbar-right">
			...
			<li><a href="home.php" style="background:green;color:#fff;font-size:18px;margin-left:3px;">Home</a></li>			
			<li><a href="updateprofile.php" style="background:green;color:#fff;font-size:18px;margin-left:3px;">Update Profile</a></li>			
		...
		<div class="row">
			...
			<div class="col-md-4 sidebar">
				...
				<div class="list-group">
				  ...
				  <a href="changepwd.php" class="list-group-item" style="background:green;color:#fff;font-size:18px;">Change Password</a>
